...
import org.mule.runtime.module.extension.internal.loader.java.ExtensionOperationModelDescriptorProperty;
...
import org.mule.runtime.module.extension.internal.loader.java.type.ExtensionParameterDescriptorModelProperty;
...
public class DynamicMetadataDeclarationEnricher implements DeclarationEnricher {
  ...
  private class EnricherDelegate extends AbstractAnnotatedDeclarationEnricher {
    ...
    private void enrichOperationMetadata(OperationDeclaration declaration) {
      declaration.getModelProperty(ExtensionOperationModelDescriptorProperty.class)
          .map(ExtensionOperationModelDescriptorProperty::getOperationMethod)
          .filter(MethodElement::supportClasses)
          .ifPresent(operation -> {
    ...
    private void parseMetadataAnnotations(ExtensionParameter element, BaseDeclaration baseDeclaration) {
      ...
      if (element.isAnnotatedWith(MetadataKeyPart.class)) {
        MetadataKeyPart metadataKeyPart = element.getAnnotation(MetadataKeyPart.class).get();
