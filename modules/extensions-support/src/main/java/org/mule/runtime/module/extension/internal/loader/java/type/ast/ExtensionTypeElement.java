...
public class ExtensionTypeElement extends ConfigurationASTElement implements ExtensionElement {
  ...
  public Category getCategory() {
    VariableElement enumValue = getValueFromAnnotation(Extension.class).get().getEnumValue(Extension::category);
  ...
  public String getVendor() {
    return getValueFromAnnotation(Extension.class).get().getStringValue(Extension::vendor);
  }
  ...
  public String getName() {
    return getValueFromAnnotation(Extension.class).get().getStringValue(Extension::name);
  }
}
